...
global.owner = process.env.OWNER_NUMBER  || '94701992015' ;  // +94773928816
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=vFE2hazZ#oDiuYkBHtR0go1gdMEV3tD_BQN6Dikbed9DG4uYxkzQ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS'stope' ,    
...
AI_MODE: process.env.AI_MODE === undefined ? 'underfined' : process.env.AI_MODE,
ANTI_LINK: process.env.ANTI_LINK || false  ,
BOT_DETECT: process.env.BOT_DETECT === undefined ? 'false' : process.env.BOT_DETECT,    
ANTI_BOT: process.env.ANTI_BOT || false  ,
ANTI_CALL: process.env.ANTI_CALL || true  ,
ALIVE: process.env.ALIVE || `defead`,     
